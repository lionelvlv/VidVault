// js/utils.js — pure formatting helpers, no DOM access
...
/**
 * Compute a 1-5 star score from like/view ratio.
...
export function renderStars(score) {
  ...
  return `<span class="stars-filled">${'&#9733;'.repeat(score)}</span>`
       + `<span class="stars-empty">${'&#9734;'.repeat(5 - score)}</span>`;
}
